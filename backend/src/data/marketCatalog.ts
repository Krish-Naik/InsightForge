...
export const SECTOR_MAP: Record<string, string[]> = {
  Banking: ['HDFCBANK', 'ICICIBANK', 'SBIN', 'KOTAKBANK', 'AXISBANK', 'BANKBARODA', 'INDUSINDBK', 'PNB', 'FEDERALBNK', 'IDFCFIRSTB', 'RBLBANK', 'AUBANK', 'UJVHANBANK', 'BANDHANBNK', 'CANBK', 'INDIANB'],
  IT: ['TCS', 'INFY', 'WIPRO', 'HCLTECH', 'TECHM', 'LTIM', 'PERSISTENT', 'COFORGE', 'MPHASIS', 'TATAELXSI', 'CYIENT', 'LTI', 'TANLA', 'ZENSARTECH', 'MPHASIS'],
  Auto: ['TATAMOTORS', 'MARUTI', 'M&M', 'BAJAJ-AUTO', 'HEROMOTOCO', 'EICHERMOT', 'ASHOKLEY', 'BALKRISIND', 'MOTHERSON', 'EXIDEIND', 'BOSCHLTD', 'SAMYARD', 'MUNJALAU', 'VARROC', 'SJS'],
  Metals: ['TATASTEEL', 'JSWSTEEL', 'HINDALCO', 'VEDL', 'COALINDIA', 'NMDC', 'SAIL', 'JINDALSTEL', 'WELCORP', 'RATNAMANI', 'GRAUWEIL'],
  Pharma: ['SUNPHARMA', 'DRREDDY', 'CIPLA', 'DIVISLAB', 'BIOCON', 'LUPIN', 'AUROPHARMA', 'TORNTPHARM', 'APLLTD', 'GLENMARK', 'ZYDUSWELL', 'IPCALAB', 'SHREYAS', 'AMBEER'],
  Energy: ['RELIANCE', 'NTPC', 'POWERGRID', 'ONGC', 'BPCL', 'TATAPOWER', 'PETRONET', 'GAIL', 'IOC', 'HINDPETRO', 'RELIGARE', 'OIL', 'GAIL'],
  FMCG: ['ITC', 'HINDUNILVR', 'NESTLEIND', 'BRITANNIA', 'DABUR', 'GODREJCP', 'MARICO', 'COLPAL', 'EMAMILTD', 'JUBLFOOD', 'RADICO', 'VARUNBEV'],
  Realty: ['DLF', 'GODREJPROP', 'OBEROIRLTY', 'PRESTIGE', 'SOBHA', 'PHOENIXLTD', 'BRIGADE', 'MAHINDRAE', 'GODREJLAND', 'SUNTECK', 'SHANKARA'],
  Telecom: ['BHARTIARTL', 'IDEA', 'TEJASNET', 'VODAFONE', 'GTPL'],
  Infra: ['LT', 'ADANIPORTS', 'IRCTC', 'CONCOR', 'NBCC', 'RVNL', 'GMRINFRA', 'BPCL', 'TATAPOWER', 'POWERGRID'],
  NBFC: ['BAJFINANCE', 'BAJAJFINSV', 'SHRIRAMFIN', 'CHOLAFIN', 'MUTHOOTFIN', 'MANAPPURAM', 'LICHSGFIN', 'SBICARD', 'HDBFIN', 'CHOLAHLDNG', 'SPANDANA'],
  SmallCap: ['ADANIENT', 'ADANIGAS', 'ADFFOODS', 'AJMERA', 'ALEMBICLTD', 'ALKYLAMINE', 'ALOKINDS', 'AMARAJABAT', 'ANUP', 'APLLTD', 'ARCB', 'ARIHANTCAP', 'ARIHANTFOODS', 'ARVIND', 'ASHOKLEY', 'ATUL', 'AVANTIFEED', 'BANDHANBNK', 'BEML', 'BHEL', 'CAMP', 'CANTABIL', 'CAPL', 'CARBORUNIV', 'CENTURYPLY', 'CENTURYTEXT', 'CHAMBLFERT', 'CHEMCON', 'CHENNPETRO', 'COROMANDEL', 'CROMPTON', 'CUB', 'DBL', 'DEEPAKNTR', 'DHFL', 'DIXON', 'DMART', 'DOD', 'DWARKESH', 'EDELWEISS', 'EIHOTEL', 'EIMCOELECON', 'ELGIEQUIP', 'ELIN', 'EQUITAS', 'ESCORTS', 'EXIDEIND', 'FINEORG', 'FINPIPE', 'FMGOETZE', 'GABRIEL', 'GANECOS', 'GDL', 'GENUSPACE', 'GEPIL', 'GESHIP', 'GLENMARK', 'GMRINFRA', 'GOCOLORS', 'GODREJAG', 'GODREJIND', 'GODREJP', 'GODREJPROP', 'GPIL', 'GRASIM', 'GSFC', 'GSPL', 'GUFIC', 'HBSL', 'HCC', 'HCLTECH', 'HERO', 'HFCL', 'HIKAL', 'HINDPETRO', 'HINDZINC', 'HONASA', 'HUBTOWN', 'IDBI', 'IDFC', 'IEX', 'IFBIND', 'IGL', 'INDHOTEL', 'INDIACEM', 'INDIAMART', 'INDIGO', 'INDUSTOWER', 'INTELACT', 'IOB', 'IPCALAB', 'JBL', 'JCHAC', 'JINDALPOLY', 'JKCEMENT', 'JKLAKSHMI', 'JMFINANC', 'JOC', 'JPASSOCIAT', 'JSL', 'JSWENERGY', 'JUBLFOOD', 'JUBLIN', 'JVS', 'JYOTHYLAB', 'KALPATPOWR', 'KANSAINER', 'KCP', 'KDDL', 'KEI', 'KNRCON', 'KOLTEPATIL', 'KRBL', 'KSB', 'LAXMIMACH', 'LEMONTREE', 'LICHSGFIN', 'LINDEINDIA', 'LTIM', 'MAHABANK', 'MAHINDCIE', 'MAHLIFE', 'MANAPPURAM', 'MANINFRA', 'MAS', 'MATRIMONY', 'MAWPHL', 'MAXHEALTH', 'MCDOWELL-N', 'MCL', 'MCX', 'MEDICAMEQ', 'MGL', 'MHRIL', 'MINDACORP', 'MINDAIND', 'MOIL', 'MOREPENLAB', 'MOTHERSUMI', 'MPHASIS', 'MRF', 'MRL', 'MRPL', 'MUTHOOTFIN', 'NAC', 'NAUKRI', 'NAVINFLUOR', 'NCC', 'NETWORK18', 'NGLFINE', 'NHC', 'NOCIL', 'NOID', 'NURMJ', 'OBEROIRLTY', 'OIL', 'OMAXE', 'ONMOBILE', 'ORIENTCEM', 'ORIENTELEC', 'PAISALO', 'PCBL', 'PERSISTENT', 'PFIZER', 'PIIND', 'PNCINFRA', 'PRAJIND', 'PRINCE', 'PRISM', 'PRIVISCL', 'PROPTIG', 'PVR', 'QUESS', 'RADIOCITY', 'RAILTEL', 'RAJRAYON', 'RAJTV', 'RAMCOIND', 'RAMCOSYS', 'RAMPRE', 'RANCH', 'RCOM', 'RCORP', 'REDINGTON', 'REFEX', 'RENGAS', 'RITES', 'RIVIGO', 'RSYSTEMS', 'RUBYMILL', 'RUPA', 'SABASE', 'SANDHAR', 'SANGAM', 'SANGHIIND', 'SARK', 'SCHAEFFLER', 'SEAMABLE', 'SELL', 'SEPOWER', 'SHYAMMETL', 'SIIL', 'SILGO', 'SIRCA', 'SIS', 'SJVN', 'SKFINDIA', 'SOUTHBANK', 'SPANDANA', 'SPCEN', 'SPICEJET', 'SPL', 'SPML', 'SRF', 'SRO', 'SSWL', 'STAR', 'STCINDIA', 'STEELXIND', 'STLTECH', 'SUBEX', 'SUDARSHAN', 'SUJ', 'SUMICHEM', 'SUNFLAG', 'SUNTECK', 'SUPRAJIT', 'SUPREMEIND', 'SWANENERGY', 'SYNGENE', 'SYRMA', 'TATACHEM', 'TATACOMM', 'TATACOFFEE', 'TATAELXSI', 'TATAGLOBAL', 'TATAINVEST', 'TATVA', 'TEJASNET', 'TFCILTD', 'THERMAX', 'THOMASCOOK', 'THYROCARE', 'TI', 'TIDCO', 'TNP', 'TOSHIBA', 'TREEHOUSE', 'TRITURBINE', 'TV18BRDCST', 'UCHW', 'UFLEX', 'ULMAT', 'UNICHEM', 'UNO', 'URJA', 'USHAMART', 'UTI', 'UTIAMC', 'VAKRANGE', 'VARROC', 'VASCONEQ', 'VBL', 'VENKEYS', 'VENUSREM', 'VGUARD', 'VINATIORG', 'VIPIND', 'VIRCHOW', 'VISAKA', 'VMART', 'VRLLOG', 'VSL', 'WABCOINDIA', 'WELCORP', 'WELSPUNS', 'WENDT', 'WESTLIFE', 'WHEELS', 'WOCKPHARMA', 'WONDERLA', 'WSF', 'ZENSARTECH', 'ZFCVINDIA', 'ZOMATO', 'ZYDUSWELL'],
};
...
const STOCK_SEEDS: Record<string, StockSeed> = {
  ...
  TATAMOTORS: { name: 'Tata Motors Limited', aliases: ['TATA MOTORS'], upstoxInstrumentKey: 'NSE_EQ|INE155A01022' },
  ...
  LTIM: { name: 'LTIMindtree Limited', aliases: ['LTIMINDTREE'] },
