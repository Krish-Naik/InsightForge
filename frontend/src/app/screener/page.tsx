...
const FILTER_CATEGORIES = {
  ...
  Financials: [
    { value: 'revenueFromOperations', label: 'Revenue (₹L)' },
    { value: 'profitAfterTax',      label: 'Net Profit (₹L)' },
    { value: 'eps',                label: 'EPS (₹)' },
    { value: 'bookValuePerShare',   label: 'Book Value/Share (₹)' },
    { value: 'roe',               label: 'ROE (%)' },
    ...
    { value: 'dividendPerShare',   label: 'Dividend/Share (₹)' },
    { value: 'dividendYield',    label: 'Dividend Yield (%)' },
    { value: 'dividendPayoutRatio', label: 'Dividend Payout (%)' },
    { value: 'operatingCashFlow', label: 'Operating CF (₹L)' },
    { value: 'freeCashFlow',     label: 'Free Cash Flow (₹L)' },
    { value: 'cashConversion',  label: 'Cash Conversion (%)' },
    { value: 'receivablesDays',  label: 'Receivables Days' },
    { value: 'inventoryDays',    label: 'Inventory Days' },
    { value: 'payableDays',      label: 'Payable Days' },
    { value: 'cashConversionCycle', label: 'Cash Conversion Cycle' },
    { value: 'totalAssets',        label: 'Total Assets (₹L)' },
    { value: 'totalEquity',        label: 'Total Equity (₹L)' },
    { value: 'totalLiabilities', label: 'Total Liabilities (₹L)' },
    { value: 'borrowingsTotal',  label: 'Total Borrowings (₹L)' },
    { value: 'revenueGrowth',     label: 'Revenue Growth YoY (%)' },
    { value: 'profitGrowth',     label: 'Profit Growth YoY (%)' },
    { value: 'epsYoYGrowth',   label: 'EPS Growth YoY (%)' },
    { value: 'equityGrowth',   label: 'Equity Growth YoY (%)' },
  ],
  Valuation: [
    { value: 'dividendYield',    label: 'Dividend Yield (%)' },
